...
import "https://github.com/Scars525/CBCT/blob/main/CBCTRewards.sol";
import "https://github.com/Scars525/CBCT/blob/main/Collection.sol";
...
// I hope you get the idea based on the example. Set for Cronos Chain 6 sec block.
// rewardmath = 25 ether .... (This gives .5 token per day per NFT staked to the staker)
// rewardmath = 50 ether .... (This gives 1 token per day per NFT staked to the staker)
// rewardmath = 100 ether .... (This gives 2 tokens per day per NFT staked to the staker)
// rewardmath = 250 ether .... (This gives 5 tokens per day per NFT staked to the staker)
// rewardmath = 500 ether .... (This gives 10 tokens per day per NFT staked to the staker)
  ...
  function _claim(address account, uint256[] calldata tokenIds, bool _unstake) internal {
    ...
    for (uint i = 0; i < tokenIds.length; i++) {
      ...
      rewardmath = 25 ether * (block.timestamp - stakedAt) / 86400 ;
